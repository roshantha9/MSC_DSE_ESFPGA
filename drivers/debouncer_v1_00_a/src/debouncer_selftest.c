//////////////////////////////////////////////////////////////////////////////
// Filename:          D:\Xtemp\hrm506_EMB\Lab56/drivers/debouncer_v1_00_a/src/debouncer_selftest.c
// Version:           1.00.a
// Description:       Contains a diagnostic self-test function for the debouncer driver
...
XStatus DEBOUNCER_SelfTest(void * baseaddr_p)
{
  ...
  DEBOUNCER_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = DEBOUNCER_mReadSlaveReg0(baseaddr, 0);
  ...
  DEBOUNCER_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = DEBOUNCER_mReadSlaveReg1(baseaddr, 0);
