------------------------------------------------------------------------------
-- milisec_timer.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          milisec_timer.vhd
-- Version:           1.00.a
-- Description:       Top level design, instantiates library components and user logic.
-- Date:              Mon Mar 07 16:49:35 2011 (by Create and Import Peripheral Wizard)
...
library milisec_timer_v1_00_a;
use milisec_timer_v1_00_a.user_logic;
...
end entity milisec_timer;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of milisec_timer is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity milisec_timer_v1_00_a.user_logic
    generic map
    (
