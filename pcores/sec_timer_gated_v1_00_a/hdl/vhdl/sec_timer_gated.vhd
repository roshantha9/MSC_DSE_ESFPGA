------------------------------------------------------------------------------
-- sec_timer_gated.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
library sec_timer_gated_v1_00_a;
use sec_timer_gated_v1_00_a.user_logic;
...
end entity sec_timer_gated;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of sec_timer_gated is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity sec_timer_gated_v1_00_a.user_logic
    generic map
    (
