...
-- Date:              Tue Mar 01 14:55:45 2011 (by Create and Import Peripheral Wizard)
...
begin
  ...
  INTR_PROC : process( Bus2IP_Clk ) is
    constant COUNT_SIZE   : integer := 27;
    --constant ALL_ONES     : std_logic_vector(0 to COUNT_SIZE-1) := (others => '1');
	--constant ALL_ONES     : std_logic_vector(0 to COUNT_SIZE-1) := "011000011000011000011000011"; -- clock:50Mhz
	--constant ALL_ONES		: std_logic_vector(0 to COUNT_SIZE-1) := "101111101011110000100000000"; -- clock:100Mhz
	constant ALL_ONES	: std_logic_vector(0 to COUNT_SIZE-1) := "100110001001011010000000000"; -- clock 80MHz
