...
architecture IMP of user_logic is
 ...
 begin
  ...
  INTR_PROC : process( Bus2IP_Clk ) is
	...
	constant ALL_ONES	  : std_logic_vector(0 to COUNT_SIZE-1) := "0000000000100100000";
  ...
  begin
	...
	if(Bus2IP_Reset ='1') then
		...
		if(intr_counter(0)='1') then
			reg_bz_out <= not reg_bz_out;
		else
			reg_bz_out <= reg_bz_out;
		end if;
	end if;  
  end process;
